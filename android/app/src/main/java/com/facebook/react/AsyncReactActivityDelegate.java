 ...
 */
public class AsyncReactActivityDelegate {
    ...
    public AsyncReactActivityDelegate(AsyncReactActivity activity, @Nullable String mainComponentName) {
        mActivity = activity;
        mMainComponentName = mainComponentName;
    }
    ...
    public void createDelegate() {
        ...
        mReactDelegate =
                new ReactDelegate(
                    ...
                    @Override
                    protected ReactRootView createRootView() {
                        return AsyncReactActivityDelegate.this.createRootView();
                    }
                };
    }
